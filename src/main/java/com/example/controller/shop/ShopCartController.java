...
@Controller
@RequestMapping(value = "beauty/cart")
public class ShopCartController {
	...
	// return new ResponseEntity<String>("Đã thêm sản phẩm vào giỏ hàng thành
	// công.", HttpStatus.OK);
	// }
	@PostMapping(value = "/add")
	@ResponseBody
	public ResponseEntity<String> addToCart(@RequestBody OrderItem item) {
		if (securityService.isAuthenticated()) {
			...
			return new ResponseEntity<String>("Đăng nhập để thực hiện chức năng này.", HttpStatus.UNAUTHORIZED);
		}
	}
